...
import type { SelectedBazelTargetData } from "../../application/services/build-manager.service";
import { getCurrentBazelWorkspacePath, getWorkspacePath } from "../../shared/utils/bazel-utils.js";
import { type BazelPackage, parseBazelBuildFile } from "../../shared/utils/bazel-utils.js";
...
import type { BazelWorkspaceCacheData, BazelWorkspaceEventData } from "./tree-types";
